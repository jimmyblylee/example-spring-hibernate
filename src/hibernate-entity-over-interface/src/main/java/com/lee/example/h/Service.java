...
public class Service {
    ...
    public List<Group> getAllGroups() {
        return session.createQuery("from com.lee.example.h.entity.Group").getResultList();
    }

    @SuppressWarnings("unchecked")
    public List<User> getAllUsers() {
        return session.createQuery("from com.lee.example.h.entity.User").getResultList();
    }
